...
def test_account_and_settings_team_owner_my_profile_leave_company_flow_check(page):
    print("----- 70번 - 계정 및 설정 > 팀오너 > 내프로필 > 소속회사 떠나기 플로우 확인 테스트 시작 -----")
    ...
    print("----- 70번 - 계정 및 설정 > 팀오너 > 내프로필 > 소속회사 떠나기 플로우 확인 테스트 시작 -> 성공 -----")
