...
def test_signupforfree_complete(page):
    ...
    :type page: object
    """
    ## 20251212 이전 동작 코드에서 사용한 확인용 -> print("----- 2번 - 회원가입 완료 스크립트 테스트 시작 -----")
    print("----- 20251212 - 회원가입 완료 전까지 프로레스 확인 스크립트 테스트 시작 -----")
...
#------ 20251212 - 아래의 케이스는 회원가입 > 가입하기 완료 프로세스이나 지속적인 테스트 계정 생성으로 인해 회원가입 테스트 플로우 변경 -----#
