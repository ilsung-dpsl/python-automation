...
def test_discover_persona_setup_check(page):
    ...
    page.get_by_role("link", name="발견하기").nth(1).click(timeout=10000)
    ...
    print("발견하기 페이지 진입 후 페르소나 설정 안내 모달 노출 확인 완료")
    ...
    print("----- 39번 - 발견하기 최초 진입 시 퍼소나 설정 안내 모달 표시 및 퍼소나 설정 추가 확인 테스트 시작 -> 성공 -----")
