...
def test_MO_login(mobile_page):
    ...
    assert "왼쪽 메뉴에서 필터를 선택하여 회사 검색을 시작하세요." in mobile_page.content(), "로그인 후 탐색하기 페이지 이동 실패 - 로그인 실패 1"
    ...
    assert "BAEK ILSUNG님" in mobile_page.content(), "대시보드: 환영문구 확인 -> 로그인 실패"
