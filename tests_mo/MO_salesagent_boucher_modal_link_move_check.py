...
def test_MO_salesagent_boucher_modal_link_move_check(mobile_page):
    ...
    print("MO Web - 정부가 인증한 AI 기반 해외 영업 지원 서비스 모달 출력 완료")
    ...
    assert config.BOUCHER1_URL == mobile_page2.url, \
        "MO Web - 산업통상자원부 바로가기 1 -> 수출 바우처 사업 url 연동 실패 - 정부가 인증한 AI 기반 해외 영업 지원 서비스 모달 > 각 URL 연동 확인 실패 1"
    ...
    assert config.BOUCHER3_URL == mobile_page2.url, \
        "MO Web - 과학기술정보통신부 바로가기 3 -> AI 바우처 사업 url 연동 실패 - 정부가 인증한 AI 기반 해외 영업 지원 서비스 모달 > 각 URL 연동 확인 실패 5"
    ...
    assert config.BOUCHER4_URL == mobile_page2.url, \
        "MO Web - 문화체육관광부 바로가기 4 -> 전통문화 혁신 바우처 사업 url 연동 실패 - 정부가 인증한 AI 기반 해외 영업 지원 서비스 모달 > 각 URL 연동 확인 실패 7"
    ...
    assert config.BOUCHER5_URL == mobile_page2.url, \
        "MO Web - 한국데이터산업진흥원 바로가기 5 -> 데이터 바우처 사업 url 연동 실패 - 정부가 인증한 AI 기반 해외 영업 지원 서비스 모달 > 각 URL 연동 확인 실패 9"
